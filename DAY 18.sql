...
-- Inserting sample data for hotel bookings for 2024 and 2023


INSERT INTO hotel_bookings (booking_date, hotel_name, total_guests, total_nights, total_price) VALUES
    ('2024-01-05', 'Hotel A', 2, 3, 300.00),
    ('2024-02-10', 'Hotel B', 3, 5, 600.00),
    ('2024-03-15', 'Hotel A', 4, 2, 400.00),
    ('2024-04-20', 'Hotel B', 2, 4, 500.00),
    ('2024-05-25', 'Hotel A', 3, 3, 450.00),
    ('2024-06-30', 'Hotel B', 5, 2, 350.00),
    ('2024-07-05', 'Hotel A', 2, 5, 550.00),
    ('2024-08-10', 'Hotel B', 3, 3, 450.00),
    ('2024-09-15', 'Hotel A', 4, 4, 500.00),
    ('2024-10-20', 'Hotel B', 2, 3, 300.00),
    ('2024-11-25', 'Hotel A', 3, 2, 350.00),
    ('2024-12-30', 'Hotel B', 5, 4, 600.00),
